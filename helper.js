...
const nextTimeBox = document.getElementById("nextTime");
...
export function isBrowsingInMobile() {
    let check = false;
...
let hitInstruction;
let dodgeInstruction;

if (isBrowsingInMobile()) {
    hitInstruction = "Tap 👊  |  Swipe ☝  |  Swipe 👉";
    dodgeInstruction = "Swipe 👇  |  Swipe 👈";
}
else {
    hitInstruction = "Click |  Key 🔼  |  Key ▶️";
    dodgeInstruction = "Double Click  |  Key 🔽  |  Key ◀️";
}
document.getElementById("hitInstruction").innerHTML = hitInstruction;
document.getElementById("dodgeInstruction").innerHTML = dodgeInstruction;